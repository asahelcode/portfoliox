            ...
            {activeBtn === "portfolio" &&
              projects?.map((project) => (
                <div className="relative group">
                  ...
                  />
                  <div className="cursor-pointer dark:text-[#3D3D3D] absolute w-[22.7rem] top-0 bottom-0 left-4 lg:w-[10rem] lg:h-[6.4rem] lg:top-11 lg:rounded-md lg:right-0 rounded-xl bg-[#FFE071E0] opacity-0 group-hover:opacity-80 transition-opacity duration-200 z-10 flex justify-center items-center flex-col">
